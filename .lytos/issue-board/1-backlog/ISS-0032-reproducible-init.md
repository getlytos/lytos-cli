...
- [ ] Method files are copied into the npm package at build time (e.g. `dist/method/`)
- [ ] `lyt init` reads from bundled files, no network call
- [ ] `lyt init` works 100% offline
- [ ] Existing tests still pass
- [ ] `npm pack` includes the bundled files
- [ ] README updated to reflect offline-first init
