...
|---|-------|----------|--------|---------|
| [ISS-0074](1-backlog/ISS-0074-frontmatter-schema-v2.md) | Frontmatter schema v2 (auditabilité durable) | P1-high | L | — |
...
| [ISS-0073](1-backlog/ISS-0073-review-export-ergonomics.md) | Clean up `lyt review` export ergonomics (drop redundant --export, add --save) | P3-low | S | ISS-0072 |
...
|---|-------|----------|--------|
| [ISS-0072](4-review/ISS-0072-review-prompt-hygiene.md) | Gitignore .lytos/review/ and document prompt-export convention | P1-high | XS |
